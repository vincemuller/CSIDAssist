...
This is the repository for the AppStore version of the application.  I am currently working on a massive update which is scheduled for a early 2025 release.  Please visit https://github.com/vincemuller/CSID_Simple to see my current work.
---
...
## Technologies Used
- **Languages**: Swift
- **Frameworks**: UIKit, SwiftUI, SQLite3, Amplify, GraphQL
- **Tools**: Xcode, Figma
...
## Future Enhancements
I am actively enhancing CSIDAssist to expand its functionality and improve the user experience. Please visit https://github.com/vincemuller/CSID_Simple to see this work thus far).
