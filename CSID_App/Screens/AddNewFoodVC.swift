...
class AddNewFoodVC: UIViewController, UITextFieldDelegate, UITextViewDelegate {
    ...
    @objc func createNewFood() {
        ...
        let newFoodItem = YourFoodItem(category: "Your Food", description: description, portionSize: portionSize, ingredients: ingredientsTextField.text ?? "", totalCarbs: carbs, totalFiber: fiber, totalSugars: sugars, addedSugars: addedSugars)
        yourFoodData.append(newFoodItem)
